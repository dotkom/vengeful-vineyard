...
export const TabNav = ({
	...
	const prefetchGroup = (group: Group) =>
		queryClient.prefetchQuery(groupLeaderboardQuery(group.group_id));
			...
			<div className="mx-auto w-[86%] md:w-[90%]">
				<div className="flex flex-row justify-between items-center w-full">
					<div className="flex flex-row gap-x-6 items-center w-full">
						<nav
							className="flex flex-row items-center gap-x-3 md:gap-x-6 w-full"
							aria-label="TabNavs"
						>
							{groups !== undefined ? (
								<>
