  ...
  return (
    <div className="w-full">
      <Tab.Group onChange={onChange}>
        ...
        <Tab.List className={classNames("flex flex-row gap-x-1 rounded-md bg-slate-200/50 p-1", label ? "mt-1" : "")}>
            ...
            <Tab
              ...
              className={({ selected }) =>
                classNames(
                  ...
                  selected ? "bg-white text-gray-700 shadow" : "text-gray-700 hover:bg-white/[0.3] hover:text-gray-800"
                )
              }
            >
              {category.label}
