...
interface TableItemProps {
  ...
  ) => Promise<QueryObserverResult<never>>
  i?: number
}
    ...
    <AccordionItem value={user.user_id}>
      <AccordionTrigger className="relative flex cursor-pointer justify-between gap-x-6 px-4 py-5 hover:bg-gray-50 sm:px-6">
        <div className="flex items-center gap-x-2">
          <span className="flex h-12 w-12 items-center justify-center rounded-full bg-indigo-100 pb-1 align-middle text-3xl text-[#4C4C51]">
